...
In order to better implement some of the changes that have been made in DominoCellNet, the structure of the domino object has been modified. Here, we describe the data that is stored in the domino object, as well as how best to access this data.
...
```{r list-functions}
ls("package:DominoCellNet", pattern = "^dom_")
```
