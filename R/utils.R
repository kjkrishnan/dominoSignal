...
#' @export
#' @examples
#' database_name <- dom_database(DominoCellNet:::pbmc_dom_built_tiny)
#' full_database <- dom_database(DominoCellNet:::pbmc_dom_built_tiny, name_only = FALSE)
#' 
...
#' @export
#' @examples
#' zscores <- dom_zscores(DominoCellNet:::pbmc_dom_built_tiny)
#'
...
#' @export
#' @examples
#' counts <- dom_counts(DominoCellNet:::pbmc_dom_built_tiny)
#' 
...
#' @export
#' @examples
#' cluster_names <- dom_clusters(DominoCellNet:::pbmc_dom_built_tiny)
#' cell_cluster_label <- dom_clusters(DominoCellNet:::pbmc_dom_built_tiny, labels = TRUE)
#' 
...
#' @export
#' @examples
#' tf_activation <- dom_tf_activation(DominoCellNet:::pbmc_dom_built_tiny)
#' 
...
#' @export
#' @examples
#' cor_matrix <- dom_correlations(DominoCellNet:::pbmc_dom_built_tiny)
#' 
...
#' @export
#' @examples
#' complexes <- dom_linkages(DominoCellNet:::pbmc_dom_built_tiny, "complexes")
#' tf_rec_by_cluster <- dom_linkages(DominoCellNet:::pbmc_dom_built_tiny, "tf-receptor", TRUE)
#' 
...
#' @export
#' @examples
#' monocyte_signaling <- dom_signaling(DominoCellNet:::pbmc_dom_built_tiny, cluster = "CD14_monocyte")
#' 
...
#' @export
#' @examples
#' de_mat <- dom_de(DominoCellNet:::pbmc_dom_built_tiny)
#' 
dom_de <- function(dom) {
    slot(dom, "clust_de")
}
...
#' @export
#' @examples
#' build_details <- dom_info(DominoCellNet:::pbmc_dom_built_tiny)
#' 
