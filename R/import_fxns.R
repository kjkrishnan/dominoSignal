...
#' @examples
#' rl_map_tiny <- create_rl_map_cellphonedb(genes = DominoCellNet:::genes_tiny, 
#'  proteins = DominoCellNet:::proteins_tiny, interactions = DominoCellNet:::interactions_tiny, 
#'  complexes = DominoCellNet:::complexes_tiny)
#' 
...
#' @examples
#' regulon_list_tiny <- create_regulon_list_scenic(regulons = DominoCellNet:::regulons_tiny)
#'
...
#'  rl_map = DominoCellNet:::rl_map_tiny, features = DominoCellNet:::auc_tiny, 
#'  counts = DominoCellNet:::RNA_count_tiny, z_scores = DominoCellNet:::RNA_zscore_tiny,
#'  clusters = DominoCellNet:::clusters_tiny, tf_targets = DominoCellNet:::regulon_list_tiny, 
...
#' rl_map_expanded <- add_rl_column(map = DominoCellNet:::rl_map_tiny, map_ref = "type_A",
