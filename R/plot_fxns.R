...
#' @examples
#' #basic usage
#' signaling_heatmap(DominoCellNet:::pbmc_dom_built_tiny)
#' #scale
#' signaling_heatmap(DominoCellNet:::pbmc_dom_built_tiny, scale = "sqrt")
#' #normalize
#' signaling_heatmap(DominoCellNet:::pbmc_dom_built_tiny, normalize = "rec_norm")
#'
...
#' incoming_signaling_heatmap(DominoCellNet:::pbmc_dom_built_tiny, "CD8_T_cell")
#'
...
#' @examples 
#' #basic usage
#' signaling_network(DominoCellNet:::pbmc_dom_built_tiny)
#' # scaling, thresholds, layouts, selecting clusters
#' signaling_network(
#'  DominoCellNet:::pbmc_dom_built_tiny, showOutgoingSignalingClusts = "CD14_monocyte", 
...
#' #basic usage
#' gene_network(
#'  DominoCellNet:::pbmc_dom_built_tiny, clust = "CD8_T_cell", 
...
#' @examples 
#' #basic usage
#' feat_heatmap(DominoCellNet:::pbmc_dom_built_tiny)
#' #using thresholds
#' feat_heatmap(
#'  DominoCellNet:::pbmc_dom_built_tiny, min_thresh = 0.1, 
...
#' @examples 
#' #basic usage
#' cor_heatmap(DominoCellNet:::pbmc_dom_built_tiny, title = "PBMC R-TF Correlations")
#' #show correlations above a specific value
#' cor_heatmap(DominoCellNet:::pbmc_dom_built_tiny, bool = TRUE, bool_thresh = 0.25)
#' #identify combinations that are connected
#' cor_heatmap(DominoCellNet:::pbmc_dom_built_tiny, bool = FALSE, mark_connections = TRUE)
#'  
...
#' @export cor_scatter
#' @examples
#' cor_scatter(DominoCellNet:::pbmc_dom_built_tiny, "ATF4","CD22")
#'
...
#' @examples 
#' #basic usage
#' circos_ligand_receptor(DominoCellNet:::pbmc_dom_built_tiny, receptor = "FAS")
#' #specify colors
#' cols = c("red", "orange", "green", "blue", "pink", "purple", "slategrey", "firebrick", "hotpink")
#' names(cols) = levels(DominoCellNet:::pbmc_dom_built_tiny@clusters)
#' circos_ligand_receptor(DominoCellNet:::pbmc_dom_built_tiny, receptor = "FAS", cell_colors = cols)
#' 
