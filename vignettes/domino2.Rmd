...
col_int_df <- data.frame(
    "gene_A" = "ITB1,ITA11", "protein_A" = "P05556,Q9UKX5", "type_A" = "R", "name_A" = "a11b1 complex",  
    "gene_B" = "COL1A1,COL1A2", "protein_B" = "P02452,P08123", "type_B" = "L", "name_B" = "COLA1_HUMAN",
    "int_pair" = "a11b1 complex & COLA1_HUMAN", "annotation_strategy" = "manual", "source" = "manual", "database_name" = "manual"
)
